...
output_file = "./selected_training6.csv"
chunksize = 10000
...
# 4. 使用 Pipeline 執行 SVM-SMOTE + Tomek Links
print(f"使用 SVM-SMOTE 生成正樣本 並應用 Tomek Links...")
svmsmote = SVMSMOTE(sampling_strategy=1, random_state=42)
tomek = TomekLinks(sampling_strategy='majority')
pipeline = Pipeline([('SVMSMOTE', svmsmote), ('tomek', tomek)])
