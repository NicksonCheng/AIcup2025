...
# 檔案路徑
test_file = "/home/r1419r1419/Stock_Competition/Data/T50_allNG/LightGBM_model_ST_voting/selected_public_x8.csv"
model_dir = "/home/r1419r1419/Stock_Competition/Data/T50_allNG/LightGBM_model_ST_voting"
...
model_path = os.path.join(model_dir, "lightgbm_final.pkl")  # 使用最終模型
...
output_file = os.path.join(output_dir, "submission_bayes.csv")
