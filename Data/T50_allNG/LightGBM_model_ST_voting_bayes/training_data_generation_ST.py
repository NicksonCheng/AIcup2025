...
output_file = "/home/r1419r1419/Stock_Competition/Data/T50_allNG/LightGBM_model_ST_voting/selected_training8_ST.csv"
chunksize = 10000

# 目標樣本數
target_positive_samples = 7000  # SMOTE 至 7,000
...
# 5. 轉回 DataFrame
df_balanced = pd.DataFrame(X_resampled, columns=selected_features)
