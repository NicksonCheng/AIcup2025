...
# 檔案路徑
input_file = "/home/r1419r1419/Stock_Competition/Data/T50_allNG/LightGBM_model_ST_voting_Optuna/selected_training8_ST.csv"
output_dir = "/home/r1419r1419/Stock_Competition/Data/T50_allNG/LightGBM_model_ST_voting_Optuna"
...
# 2. 定義 Optuna 目標函數（5 折 CV 的 F1-score）
def objective(trial):
    params = {
        'objective': 'binary',
        'metric': 'binary_logloss',  # 僅用於訓練監控
        'boosting_type': 'gbdt',
        'n_estimators': 1000,
    ...
    for train_idx, val_idx in kf.split(X_scaled):
        ...
        model = lgb.train(
            ...
            ]  # 移除 LightGBMPruningCallback
        )
        
        val_preds_proba = model.predict(X_fold_val)
        val_preds = (val_preds_proba > 0.2).astype(int)
