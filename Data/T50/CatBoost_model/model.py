...
# CatBoost 參數（針對 F1-score 優化）
params = {
    'iterations': 500,  # 訓練輪數
    'learning_rate': 0.05,
    'depth': 7,
    'loss_function': 'Logloss',
    'eval_metric': 'F1',  # 直接優化 F1-score
    'scale_pos_weight': 5.0,  # 正樣本權重（5:1）
    'thread_count': 24,  # 使用 24 核心
    'verbose': 10,  # 每 10 次迭代顯示一次
    'random_seed': 42
}
EPOCHS = 500
...
# 4. 預測與 F1-score 優化
print("進行預測...")
val_preds_proba = model.predict_proba(X_val)[:, 1]  # 取正類概率
