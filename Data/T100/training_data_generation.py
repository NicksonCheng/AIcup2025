...
selected_features_file = "/home/r1419r1419/Stock_Competition/Data/T100/selected_features7.csv"
output_file = "/home/r1419r1419/Stock_Competition/Data/T100/selected_training.csv"
chunksize = 10000

# 目標樣本數
target_positive_samples = 10000
target_negative_samples = 50000
...
# 5. 提取 SMOTE 正樣本並從原始負樣本中抽樣 50,000
df_smote_positive = df_smote[df_smote['飆股'] == 1]  # 10,000 正樣本
df_negative_sampled = df_negative.sample(n=target_negative_samples, random_state=42)  # 直接抽樣 50,000 負樣本
print(f"抽樣後負樣本數: {len(df_negative_sampled)}")

# 6. 合併並打亂數據
df_balanced = pd.concat([df_smote_positive, df_negative_sampled], ignore_index=True)
