...
output_file = "./selected_training5.csv"
chunksize = 10000
...
# 4. 使用 Pipeline 執行 Borderline + Tomek Links
print(f"使用 Borderline 生成正樣本 並應用 Tomek Links...")
Borderline = BorderlineSMOTE(sampling_strategy=1, random_state=42)
tomek = TomekLinks(sampling_strategy='majority')
pipeline = Pipeline([('Borderline', Borderline), ('tomek', tomek)])
