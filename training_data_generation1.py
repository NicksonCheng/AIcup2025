...
output_file = "./selected_training1.csv"
chunksize = 10000

# 目標樣本數
andasyn_positive_samples = 4000
...
print(f"使用 ADASYN, SMOTE 生成正樣本至 {target_positive_samples} 並應用 Tomek Links...")
andasyn = ADASYN(sampling_strategy={1: andasyn_positive_samples}, random_state=42)
smote = SMOTE(sampling_strategy={1: target_positive_samples}, random_state=42, k_neighbors=min(5, n_positive-1))
tomek = TomekLinks(sampling_strategy='majority')
pipeline = Pipeline([('andasyn', andasyn),('smote', smote), ('tomek', tomek)])
