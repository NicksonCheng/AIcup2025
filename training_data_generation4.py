...
output_file = "./selected_training4.csv"
chunksize = 10000
...
print(f"使用 ADASYN 生成正樣本 並應用 Tomek Links...")
andasyn = ADASYN(sampling_strategy=1, random_state=42)
tomek = TomekLinks(sampling_strategy='majority')
pipeline = Pipeline([('andasyn', andasyn), ('tomek', tomek)])
