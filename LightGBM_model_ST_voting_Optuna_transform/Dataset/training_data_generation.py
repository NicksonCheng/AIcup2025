...
selected_features_file = "/home/r1419r1419/Stock_Competition/LightGBM_model_ST_voting_Optuna_transform/Dataset/selected_features8.csv"
output_file = "/home/r1419r1419/Stock_Competition/LightGBM_model_ST_voting_Optuna_transform/Dataset/selected_training8.csv"
chunksize = 10000

# 目標樣本數
target_positive_samples = 14000  # SMOTE 至 14,000
...
# 4. 使用 Pipeline 執行 SMOTE + Tomek Links
print(f"使用 SMOTE 生成正樣本至 {target_positive_samples} 並應用 Tomek Links...")
