...
# output_file = "Stock_Competition/38_Training_Data_Set_V2/selected_training.csv"
output_file = "./selected_training3.csv"
chunksize = 10000
...
print(f"使用 SMOTE 生成正樣本 並應用 Tomek Links...")
smote = SMOTE(sampling_strategy=1, random_state=42, k_neighbors=min(5, n_positive-1))
